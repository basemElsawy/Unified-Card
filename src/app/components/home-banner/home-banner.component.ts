...
@Component({
  ...
  standalone: true,
  imports: [NgbCarouselModule, CarouselModule, ButtonModule],
...
export class HomeBannerComponent {
  ...
  heroSectionData: {
    image: string, mainHeadline: string, subHeadline: string, isActive: boolean, button1?: {
  ...
  }[] = [
      {
        ...
        mainHeadline: '<h1>All Around Egypt in your <span style="color:#9CE0B2;">pocket</span> </h1>',
        subHeadline: 'new unified card for every egyptian citizen',
        isActive: true
      },
      {
        image: '../../../assets/pic1.png',
        mainHeadline: '<h1>Reserve All Kinds Of <span style="color:#9CE0B2;">Subway</span> Tickets</h1>',
      ...
      },
      {
        ...
        mainHeadline: '<h1>Find Your Way Through <span style="color:#9CE0B2;">Egypt</span></h1>',
